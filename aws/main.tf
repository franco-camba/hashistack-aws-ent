...
resource "aws_instance" "server" {
  ...
  vpc_security_group_ids = [aws_security_group.consul_nomad_vault_ingress.id, aws_security_group.ssh_ingress.id, aws_security_group.allow_all_internal.id]
...
resource "aws_instance" "client" {
  ...
  key_name               = var.key_name
  vpc_security_group_ids = [aws_security_group.consul_nomad_vault_ingress.id, aws_security_group.ssh_ingress.id, aws_security_group.clients_ingress.id, aws_security_group.allow_all_internal.id]
